...
export default async function VendorQuoteLeadPage({
  params,
}: {
  ...
  const boundCreate = createQuotation.bind(null, lead.id, "vendor");

  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      <Link href={`/vendor/leads/${lead.id}`} className="text-sm text-ink/50 hover:text-ink">
        &larr; Back to lead
      </Link>
